...
/**
 * Fetches a resource configuration by name from MCPStudio
 * @param {Object} params - Command parameters
 * @param {string} [params.resourceName] - Name of the resource to fetch (optional, defaults to error message)
 * @returns {null|null} Returns null after setting tool result with resource info or error
 */
